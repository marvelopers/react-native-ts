import React, { createContent, useContext, useRef, useCallback } from 'react';
...
const defaultAutoFocusContext = {
  autoFocus: eventEvent => {},
};
const AutoFocusContext = createContent<AutoFocusContextType>(defaultAutoFocusContext);

// export type FocusContextType = {};
// const defaultFocusContext = {};
// const AutoFocusContext = createContent<FocusContextType>(defaultFocusContext);
