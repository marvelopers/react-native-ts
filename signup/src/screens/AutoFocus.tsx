...
import { StyleSheet, View, Text, TextInput, Keyboard, Switch } from 'react-native';
import type { NativeSyntheticEvent, TextInputFocusEventData } from 'react-native';
import { KeyboardAwareScrollView } from 'react-native-keyboard-aware-scroll-view';
import { useTheme } from 'react-native-paper';
import { useToggleTheme } from '../contexts/ToggleThemeContext';
import { useAutoFocus, AutoFocusProvider } from '../contexts/AutoFocusContext';
...
const AutoFocus = () => {
  ...
  const textInputStyle = useMemo(
    () => [styles.textInput, { color: colors.text, borderColor: colors.placeholder }],
